...
@section('content')
    ...
    <section id="projects" class="">
        <div class="container">
            ...
            <p class="project-amount">{{ $tag->projects_count }} Projects</a>
            ...
            <table class="project-table">
                ...
                @foreach ($tag->projects as $project )
                    <tr>
                        ...
                        <td class="company" style="font-weight: 700;">{{ $project->company }}</td>
                        <td><div>
                        ...
                        <td class="link">
                            <a class="project-link" href="https://{{ $project->link }}">{{ $project->link }}
